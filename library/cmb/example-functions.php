...
add_action( 'cmb2_init', 'delminco_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_init' hook.
 */
function delminco_register_demo_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_delminco_demo_';
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'delminco_before_row_if_2', // callback
...
add_action( 'cmb2_init', 'delminco_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function delminco_register_about_page_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_delminco_about_';
...
add_action( 'cmb2_init', 'delminco_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function delminco_register_repeatable_group_field_metabox() {
...
add_action( 'cmb2_init', 'delminco_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function delminco_register_user_profile_metabox() {
...
add_action( 'cmb2_init', 'delminco_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function delminco_register_theme_options_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$option_key = '_delminco_theme_options';
